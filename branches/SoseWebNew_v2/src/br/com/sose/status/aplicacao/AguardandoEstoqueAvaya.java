...
@Service("aguardandoEstoqueAvayaAplicacaoStatus")
public class AguardandoEstoqueAvaya extends StatusAplicacao {

	public static final String nome = "Estoque avaya"; 

	@Autowired
	private OrdemServicoService ordemServicoService;
	
	public AguardandoEstoqueAvaya() {
		// TODO Auto-generated constructor stub
	}
	
	public AguardandoEstoqueAvaya(OrdemServico o) {
