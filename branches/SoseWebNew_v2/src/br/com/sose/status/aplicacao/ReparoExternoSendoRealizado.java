...
@Service("reparoExternoSendoRealizadoAplicacaoStatus")
public class ReparoExternoSendoRealizado extends StatusAplicacao {

	
	public static final String nome = "Reparo externo sendo realizado"; 

	@Autowired
	private OrdemServicoService ordemServicoService;
	
	public ReparoExternoSendoRealizado(OrdemServico o) {
		super.ordemServico = o;
	}
	
	public ReparoExternoSendoRealizado() {
