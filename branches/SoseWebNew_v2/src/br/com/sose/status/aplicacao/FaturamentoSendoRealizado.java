...
@Service("faturamentoSendoRealizadoAplicacaoStatus")
public class FaturamentoSendoRealizado extends StatusAplicacao {

	public static final String nome = "Faturamento sendo realizado"; 

	@Autowired
	private OrdemServicoService ordemServicoService;
	
	public FaturamentoSendoRealizado() {
		// TODO Auto-generated constructor stub
	}
	
	public FaturamentoSendoRealizado(OrdemServico o) {
