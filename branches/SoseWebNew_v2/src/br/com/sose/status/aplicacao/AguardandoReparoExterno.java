...
@Service("aguardandoReparoExternoAplicacaoStatus")
public class AguardandoReparoExterno extends StatusAplicacao {

	public static final String nome = "Aguardando reparo externo"; 

	@Autowired
	private OrdemServicoService ordemServicoService;
	
	public AguardandoReparoExterno(OrdemServico o) {
