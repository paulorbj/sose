package br.com.sose.service.laudoTecnico;
...
@Service(value="laudoTecnicoService")
@RemotingDestination(value="laudoTecnicoService")
public class LaudoTecnicoService {

	private Logger logger = Logger.getLogger(this.getClass());

	@Autowired
	public LaudoTecnicoDao laudoTecnicoDao;
