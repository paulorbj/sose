...
public class PropostaMessageService extends ServiceAdapter {
	...
	public void start() {
		...
		System.out.println("PropostaMessageService started");
		logger.debug("PropostaMessageService started");

	}

	public void stop() {

		System.out.println("PropostaMessageService stopped");
		logger.debug("PropostaMessageService stopped");
	}

	public Object invoke(Message msg) {

		System.out.println("PropostaMessageService sending message");
			logger.debug("PropostaMessageService sending message");
