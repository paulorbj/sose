...
@Service("orcamentoSendoRealizadoAplicacaoStatus")
public class OrcamentoSendoRealizado extends StatusAplicacao {

	public static final String nome = "Orçamento sendo realizado"; 

	@Autowired
	private OrdemServicoService ordemServicoService;
	
	public OrcamentoSendoRealizado(OrdemServico o) {
		super.ordemServico = o;
	}
	
	public OrcamentoSendoRealizado() {
