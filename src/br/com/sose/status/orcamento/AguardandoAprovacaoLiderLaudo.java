...
@Service("aguardandoAprovacaoLiderLaudoStatusOrcamento")
public class AguardandoAprovacaoLiderLaudo extends StatusOrcamento {
	...
	public AguardandoAprovacaoLiderLaudo(Orcamento r) {
		super.orcamento = r;
	}
	...
	public Orcamento aprovarOrcamento(Orcamento orcamento,Usuario realizadoPor) throws Exception {
		if(realizadoPor.getPerfil().getAcaoPermitirAprovarSolicitacaoLaudoTecnico()){
...
//					orcamento.getOrdemServico().setLaudoTecnico(laudoTecnico);
				...
				observacaoService.log("Orçamento", "Laudo técnico aprovado pelo líder", 2, new Date(),orcamento, realizadoPor);
			}
