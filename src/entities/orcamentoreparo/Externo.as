package entities.orcamentoreparo
{
		...
		
	{
		...
		private var _historico:ArrayCollection;
	...
	/*	private var _telefones:ArrayCollection;
		...
		*/
		...
		public function Externo(dataCriacao:Date, pessoaExterno:Pessoa, criadoPor:Usuario, nfSaida:String, nfRetorno:String)
		{
			_id=0;
			...
			_historico = new ArrayCollection();
		}
		...
		public function get historico():ArrayCollection
		{
			return _historico;
		}

		public function set historico(value:ArrayCollection):void
		{
			_historico = value;
		}
