...
@Service("expedicaoSendoRealizadoAplicacaoStatus")
public class ExpedicaoSendoRealizada extends StatusAplicacao {

	public static final String nome = "Expedição sendo realizada"; 

	@Autowired
	private OrdemServicoService ordemServicoService;
	
	public ExpedicaoSendoRealizada() {
		// TODO Auto-generated constructor stub
	}
	
	public ExpedicaoSendoRealizada(OrdemServico o) {
